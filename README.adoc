...
SrcInlineMacro, link:lib/src-inline-macro.rb[]::
Adds an inline macro for source code to allow use of the highlightjs syntax highlighter. It can be readily adapted for other syntax highlighters.
